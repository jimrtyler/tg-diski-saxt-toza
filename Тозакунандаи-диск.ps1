...
#GUI Variables
$FormTitleText = "Тозакунандаи диск аз ҷониби Ҷим Тайлер (PowerShellEngineer.com)"
$SelectDiskLabelText = "Дискро интихоб кунед:"
$FreeSpaceLabelText = "Фои озод (гигабайт): "
$TotalSpaceLabelText = "Фои умумии (гигабайт): "
$JunkFoundLabelText = "парк ёфт шуд (гигабайт):"
$CleanDiskBtnText = "Дискро тоза кунед *Нест кардани файлҳо*"
$SpaceCleanedLabelText = "Фазаи тозашуда (гигабайт): "
$LogFileLabelText = "Файли сабт ёфт: $abcdefg"
$CreditLabelText = "Скрипт аз ҷониби Ҷим Тайлер - PowerShellEngineer.com"
$LogFileLocatedText = "Файли сабт ёфт шуд"
$AnalyzingDriveText = "Таҳлили дискҳо..."
$BrowsersAreRunningText = "Браузерҳо кор мекунанд... Ба корбар хабар диҳед..."
$PleaseCloseBrowsersText = "Лутфан, ҳама браузерҳои вебро пӯшед ва дубора кӯшиш кунед."
$CleaningDriveText = "Тоза кардани диск..."
